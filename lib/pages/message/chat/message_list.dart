...
import 'package:firebase_chat_app/common/utils/date.dart';
...
//QueryDocumentSnapshot porq es el tipo d datos q estamos usando en el state.dart  del mensaje para guardar la lista de msges
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            //calculatees the time past from the received message to now
                            duTimeLineFormat(
